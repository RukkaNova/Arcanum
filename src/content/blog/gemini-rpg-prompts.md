...
For the full anatomy behind every prompt on this site — what makes a good one work on any model, not just Gemini — see [the best RPG prompts guide](/blog/rpg-prompts).
